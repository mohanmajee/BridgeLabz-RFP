...
class EmployeeWageComputation implements IEmployeeWageComputation {
    ...
    public static void main(String args[]) {    
        ...
        employeeWageComputation.addCompany("Microsoft", 7, 32, 120);        
        employeeWageComputation.addCompany("Google", 8, 26, 190);        
        employeeWageComputation.addCompany("Amazon", 9, 21, 160);        
